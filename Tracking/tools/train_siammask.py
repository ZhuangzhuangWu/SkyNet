...
#sys.path.append("/home/max/work/SkyNet/Tracking/utils/log_helper.py")
...
from log_helper import init_log, print_speed, add_file_handler, Dummy
from load_helper import load_pretrain, restore_from
from average_meter_helper import AverageMeter
from lr_helper import build_lr_scheduler
#
sys.path.append("/home/max/work/SkyNet/Tracking/datasets")
from siam_mask_dataset import DataSets
...
from custom import Custom, Custom_Sky
